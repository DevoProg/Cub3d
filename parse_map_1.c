...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/18 12:18:09 by devoma            #+#    #+#             */
/*   Updated: 2023/05/18 18:02:08 by devoma           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*no_tab(char *line)
{
	...
	i = 0;
	new_spaces = new_spaces * 3 + ft_strlen(line) + 1;
	new = malloc(sizeof(char) * new_spaces);
	if (!new)
		return (NULL);
